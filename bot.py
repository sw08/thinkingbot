...
MEMBERS = [674813875291422720, 745848200195473490, 594183416266752000, 557119176590884864, 734560292024877056, 726350177601978438, 441202161481809922]
...
async def _prime(ctx, start, end):
    if int(start) >= int(end):
        ...
        if len(primes) == 0:
            ...
            prime_str = prime_str[4:len(prime_str)] + '`'
